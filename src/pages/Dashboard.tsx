...
export default function Dashboard() {
  const { companies, watchlist } = useApp()
    ...
    <div className="page">
      <section className="hero-panel">
        ...
        <div className="hero-panel__score">
          ...
          <small>{companies.length.toLocaleString('ja-JP')}社のモックKPI平均</small>
        </div>
      </section>
      ...
      <section className="summary-grid">
        <article className="summary-card">
          ...
          <span className="summary-card__note">JPX domestic equities</span>
        </article>
        <article className="summary-card">
        ...
        <article className="summary-card">
          ...
          <span className="summary-card__note">{Math.round((warningCount / companies.length) * 100)}% of universe</span>
        </article>
        <article className="summary-card">
