    ...
    <div className="page">
      ...
      <section className="company-hero">
        ...
        <div className="company-hero__score">
          <span>総合スコア</span>
          <ScoreBadge score={company.scores.overall} />
          <small>企業情報は実在 / 財務KPIはモック</small>
        </div>
      ...
      <section className="detail-overview-grid">
        ...
        <article className="panel score-list-panel">
          ...
          <div className="detail-score-list">
            {scoreKeys.map((key) => (
              <ScoreBar key={key} label={scoreLabels[key]} score={company.scores[key]} />
            ))}
          </div>
      ...
      <section className="analysis-grid">
        ...
        <article className="panel">
          ...
          <WarningList warnings={company.warnings} />
        </article>
